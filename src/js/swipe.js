...
module.exports = new(function () {
  ...
  this.init = function(){
    ...
    */
    app.b([document], 'mousedown', e => this.onStart(e));
    app.b([document], 'mousemove', e => this.onMove(e));
    app.b([document], ['click'/*, 'mouseleave'/*, 'blur', 'keydown', 'contextmenu'*/], e => this.onEnd(e), true);
  ...
  this.swipe = function(e){
    ...
    if(app.plugins.toggle){
      if(e.n.matches(app.plugins.toggle.opt.qDrw)){
        ...
        setTimeout(() => this.undrag(e.n), 500);
      }
    }
    if(app.plugins.gallery){
      if(e.n.matches(app.plugins.gallery.opt.qGal)){
        ...
        else if(e.dir==2) app.plugins.gallery.prevImg(e.n);
        //this.undrag(e.n);
      }
    }
  }
