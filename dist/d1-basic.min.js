...
var n=i(0);t.exports=new function(){"use strict";this.name="gallery",this.opt={idPrefix:"pic-",num:!0,cGal:"gal",qGal:".gal>a[id]",qGallery:".gallery",qLinks:"a.pic"},this.init=function(){var t=this;n.listen("hash",(function(e){return t.onHash(e)})),n.listen("key",(function(e){return t.onKey(e)})),n.listen("click",(function(e){return t.onClick(e)})),this.prepareAll()},this.prepareAll=function(t){var e=this;n.e(n.qq(this.opt.qGallery,t),(function(t){return e.prepare(t)}))},this.onClick=function(t){var e=t.target;e.matches(this.opt.qGal)&&t.clientX>0&&t.clientX<e.clientWidth/3&&this.prevImg(e)&&t.preventDefault()},this.prevImg=function(t){var e=t.previousElementSibling||n.qq("a[id]",t.parentNode).pop();return e.id&&(location.hash="#"+e.id),e.id},this.onHash=function(){var t=n.q(location.hash);t&&(this.loadImg(t),this.loadImg(n.q(t.hash)))},this.loadImg=function(t){t&&t.vImg&&(t.style.backgroundImage='url("'+t.vImg+'")',t.vImg="")},this.prepare=function(t){for(var e=n.ins("div","",{className:this.opt.cGal}),i=n.qq(this.opt.qLinks,t),o=i.length,s=0,r=0;r<o;r++)if(!i[r].vDone){var a=n.seq();r||(s=a);var l=n.ins("a","",{id:this.opt.idPrefix+a,href:"#"+this.opt.idPrefix+(r==o-1?s:a+1)},e);l.vLink=n.attr(i[r],"href",""),l.vImg=n.attr(i[r],"href",""),l.setAttribute(n.opt.aCaption,(this.opt.num?r+1+"/"+o+(i[r].title?" - ":""):"")+(i[r].title||"")),i[r].href="#"+l.id,i[r].vDone=1}n.x(e),n.b(n.qq("a[id]",e),"click",n.gotoPrev),document.body.appendChild(e)},this.onKey=function(t){if(location.hash){var e=n.q(location.hash);if(e&&e.hash){var i=t.keyCode;if(37==i||38==i)this.prevImg(e);else if(39==i||40==i)location.hash=e.hash;else if(8==i){var o=e.vLink;o||(o=(o=window.getComputedStyle(e).backgroundImage).substring(4,o.length-1).replace(/^"|"$/g,"")),o&&(location.href=o)}}}}}}});