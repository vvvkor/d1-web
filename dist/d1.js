...
var _default = /*#__PURE__*/function (_Plugin) {
  ...
  _createClass(_default, [{
    ...
    value: function initValue(n, g) {
      if (g) {
        var v = _util_url_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].get(g);
...
var polyfill = __webpack_require__(8);

// EXTERNAL MODULE: ./src/js/app.js
var app = __webpack_require__(4);

// EXTERNAL MODULE: ./src/js/util/func.js
var func = __webpack_require__(3);

// EXTERNAL MODULE: ./src/js/util/dt.js
var dt = __webpack_require__(2);

// EXTERNAL MODULE: ./src/js/util/url.js
var url = __webpack_require__(1);

// EXTERNAL MODULE: ./src/js/plugins/icons.js + 1 modules
...
var toggle = __webpack_require__(5);

// EXTERNAL MODULE: ./src/js/plugins/form.js
var plugins_form = __webpack_require__(9);

// EXTERNAL MODULE: ./src/js/plugins/calendar.js
var calendar = __webpack_require__(10);

// EXTERNAL MODULE: ./src/js/plugins/lookup.js
var lookup = __webpack_require__(11);

// EXTERNAL MODULE: ./src/js/plugins/edit.js
var edit = __webpack_require__(12);
...
var tablex_default = /*#__PURE__*/function (_Plugin) {
  ...
  tablex_createClass(_default, [{
    ...
    value: function param(n, attr, def, getVar) {
      ...
      var g = n.dataset[getVar] ? url["a" /* default */].get(n.dataset[getVar]) : null;
    ...
    value: function strVal(x, mode, dec) {
      ...
      else if (mode == 'b') return this.fmtSz(x, dec);else if (mode == 'i') return this.fmtInterval(x, dec);else if (mode == 'd') return dt["a" /* default */].fmt(new Date(x), dec, this.opt.dateFormat);else return x;
    }
  }, {
    key: "fmtSz",
...
// EXTERNAL MODULE: ./src/js/plugins/valid.js
  ...
  fliptable_createClass(_default, [{
    ...
    value: function init() {
      ...
      this.app.listen('update', function (e) {
        ...
        return ((_e$n = e.n) === null || _e$n === void 0 ? void 0 : _e$n.matches(_this2.opt.qFlipTable)) ? _this2.prepareFlipTable(e.n) : null;
      });
    }
  }, {
    key: "arrange",
...
var swipe_default = /*#__PURE__*/function (_Plugin) {
  ...
  swipe_createClass(_default, [{
    ...
    value: function init() {
      ...
      this.drag_ = func["a" /* default */].throttle(function (e) {
...
src_app.plug(calendar["a" /* default */]);
src_app.plug(lookup["a" /* default */]);
src_app.plug(edit["a" /* default */]);
...
src_app.plug(fetch["a" /* default */]);
src_app.plug(valid["a" /* default */]);
